...
<html lang="en">
    ...
    <body>
        ...
        <div class="container mt-3">
            ...
            <form action="<?= base_url('Home/action_edit_barang') ?>" method="post">
                ...
                <div class="mb-3 text-white">
                    ...
                    <input type="text" class="form-control" id="name" placeholder="Enter items name" name="name" value="<?php echo $barang -> nama_barang ?>">
                ...
                <div class="mb-3 text-white">
                    ...
                    <input type="text" class="form-control" id="code" placeholder="Enter items code" name="code" value="<?php echo $barang -> kode_barang ?>">
